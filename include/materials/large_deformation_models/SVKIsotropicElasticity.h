...
class SVKIsotropicElasticity : public LargeDeformationElasticityModel,
                               public DerivativeMaterialPropertyNameInterface
{
public:
  static InputParameters validParams();

  SVKIsotropicElasticity(const InputParameters & parameters);
...
protected:
  ...
  const enum class Decomposition { none } _decomposition;
};
