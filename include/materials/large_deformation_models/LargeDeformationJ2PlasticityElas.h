...
class LargeDeformationJ2PlasticityElas : public LargeDeformationPlasticityModel
{
public:
  static InputParameters validParams();

  LargeDeformationJ2PlasticityElas(const InputParameters & parameters);
...
protected:
  ...
  ADReal degDerivative(const ADReal ep, int derivative);
