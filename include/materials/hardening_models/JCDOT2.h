...
class JCDOT2 : public PlasticHardeningModel, public DerivativeMaterialPropertyNameInterface
{
public:
  static InputParameters validParams();

  JCDOT2(const InputParameters & parameters);
...
protected:
  ...
  const MaterialPropertyName _gp_ddot_name;

  const ADMaterialProperty<Real> & _gp_ddot;
  const ADMaterialProperty<Real> & _dgp_dddot;
